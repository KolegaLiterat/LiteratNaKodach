...
int main()
{
	double kasa; //wypada za³o¿yæ, ¿e bêdzie wartoœæ 0.7
	bool kara; //nie mam pojêcia, czy dobrze tego u¿y³em; w ksi¹¿ce brakuje mi dobrego przyk³adu
	...
	if (kara > 0) { //rezygnujê ze switcha; jakoœ nie widzê sensu w sprawdzaniu switchem prawda-fa³sz
		cout << "\n"
